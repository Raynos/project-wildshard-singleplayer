/**
 * Waterfall v1 (DRIFTWOOD-REMASTER W5), kept behind `?waterfall=v1` since E150 replaced it with the toon cascade (Waterfall.ts).
 * A stylized cascade for a cliff face: E8 placed it in Wreck Cove.
 *
 *   const fall = new WaterfallV1({ lip: new THREE.Vector3(x, yTop, z), foot: new THREE.Vector3(x2, yPool, z2), width: 3 }).build();
...
import type { WaterfallSpec } from './Waterfall';
