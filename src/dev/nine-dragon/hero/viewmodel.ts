// Copied from the hero lab (src/dev/nd-lab/hero/viewmodel.ts, round-7-lab-hero) into the clean room.
...
// the round-6 hero frame (style-A-jiehua-neon.jpg): the long jian diagonal from the guard low-right to the frame's centre,
// the tassel + talisman hanging in front of the grip, the Fei Zhua small and low in the left corner
export const LAYOUT_PORTRAIT: VmLayout = {
  guard: new Vector2(0.52, -0.4), tip: new Vector2(0.07, -0.03), guardDepth: 1.05, roll: 0.12,
  wrist: new Vector2(-0.7, -0.56), wristDepth: 1.35, elbow: new Vector2(-2.0, -1.1), armRoll: -0.25, elbowDepth: 1.0, fov: 70,
};
export const LAYOUT_LANDSCAPE: VmLayout = {
  guard: new Vector2(0.52, -0.5), tip: new Vector2(0.16, -0.06), guardDepth: 1.0, roll: -0.3,
  wrist: new Vector2(-0.64, -0.62), wristDepth: 1.05, elbow: new Vector2(-1.5, -0.8), armRoll: 0.4, elbowDepth: 0.8, fov: 50,
};
