...
import { E, K, type Kit, type Look } from './base/kit';
import type { SignBuilder } from './base/signs';
...
const CINNABAR: Look = { wash: 0xb23020, line: 1, accent: true };
const CIN_DARK: Look = { wash: 0x8e2217, line: 1, accent: true };
const STONE: Look = { wash: 0xa7a39a, line: 1 };
const STONE_PANEL: Look = { wash: 0xb9b5ab, kind: K.panel, line: 1 };
