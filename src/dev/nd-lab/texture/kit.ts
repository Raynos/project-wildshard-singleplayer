// P5 texture lab: a copy of the clean room's kit.ts with Look.surf (flag bits × 4096) for the painted surfaces.
...
export interface Look {
  ...
  gold?: boolean;
  /** P5 paint: an explicit painted surface (paint.ts SURF; 0 / unset = by kind), flag bits × 4096 */
  surf?: number;
}
