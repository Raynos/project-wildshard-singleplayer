// P5 texture lab: a copy of the clean room's streaks.ts; the change is marked `P5 paint`.
...
void main() {
  ...
  // P5 paint: the reflection breaks on the painted granite's wet / dry dabs (one more sample of the flag layer)
  col *= paintWetDapple(p);
