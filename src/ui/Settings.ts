...
//   getSfxSet() / setSfxSet('tangoflux') / onSfxSet(fn)   → the sound-effect samples: 'sa3' (Stable Audio 3) | 'tangoflux'
//   (public/assets/sfx/<set>/sfx.json) | 'synth' (every sound synthesised); default 'sa3'; `?sfx=<set>` overrides like ?music=.
//
...
export const SFX_SETS = ['sa3', 'tangoflux', 'synth'] as const;
...
const sfxSet = new Choice<SfxSet>('sfxSet', SFX_SETS, 'sa3', 'sfx');
