...
export class HUD {
  ...
  constructor(opts: HUDOptions = {}) {
    ...
    document.addEventListener('pointerlockchange', () => {
      ...
      if (locked) this.setPaused(false); else if (!this.paused) this.setPaused(true);
    });
  ...
  set menu(m: GameMenu) { this._menu = m; m.keyGate = () => this.entered && !this.holdPause; m.onClose = () => { this.onResume?.(); }; m.onExit = () => { this.exitToMenu(); }; }
