 ...
 */
export interface DebugFlags { loop: 'raf' | 'timer'; tier: 'auto' | 'phone' | 'desktop'; meter: boolean; rdbg: boolean; keepalive: boolean }
const KEY = 'ws.debug';
const DEFAULTS: DebugFlags = { loop: 'raf', tier: 'auto', meter: true, rdbg: true, keepalive: false };
