 ...
 * the painting S and E. Compass azimuths: 0 = north (+z), 90 = east (−x), 180 = south, 270 = west.
 */
...
export const NALATI_HORIZON_V2: ChunkHorizon = {
  ...
  rings: [
    // near (800 m): the valley running on low to the N and W, foothills climbing S and E toward the range
    {
      ...
      bands: [
        { azimuth: 0, spread: 60, height: 22, rough: 0.05 },     // north: the Kunes valley running on, low
        { azimuth: 300, spread: 45, height: 12, rough: 0 },      // west / north-west: opening toward the Ili
        { azimuth: 90, spread: 45, height: 110, rough: 0.3 },    // east: foothills under the Crags' big brothers
        { azimuth: 140, spread: 30, height: 130, rough: 0.35 },  // south-east
        { azimuth: 190, spread: 40, height: 95, rough: 0.25 },   // south: the ring's outer shoulders
        { azimuth: 240, spread: 25, height: 45, rough: 0.12 },   // south-west: stepping down to the open west
      ],
    },
