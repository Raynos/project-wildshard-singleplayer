...
export const DRIFTWOOD_QUEST: QuestDef = {
  ...
  intro: {
    ...
    markers: [{ id: 'castaway', label: 'CASTAWAY', at: { poi: 'hut', x: 2.4, z: -8.2 } }],
  },
  steps: [
    {
      id: 'shards',
      ...
      markers: [
        { id: 'lookout', label: 'LOOKOUT SHARD', at: { poi: 'lookout', x: 0, z: 0 }, hideWhen: { all: ['shard:lookout'] } },
        { id: 'wreck', label: 'WRECK SHARD', at: { poi: 'wreck', x: 0, z: 2 }, hideWhen: { all: ['shard:wreck'] } },
        { id: 'cave', label: 'SEA CAVE SHARD', at: { poi: 'cave', x: 0, z: -3 }, hideWhen: { all: ['shard:cave'] } },
      ],
    },
    {
      id: 'shrine',
      ...
      markers: [{ id: 'shrine', label: 'RING SHRINE', at: { poi: 'shrine', anchor: 'shrine.altar', x: 0, z: 2.4 } }],
    },
    {
      id: 'captain',
      ...
      markers: [{ id: 'captain', label: 'THE DROWNED CAPTAIN', at: { poi: 'shrine', anchor: 'shrine.pool', x: 0, z: 9 } }],
    },
    {
      id: 'reward',
      ...
      markers: [{ id: 'ring', label: 'THE RING', at: { poi: 'shrine', anchor: 'shrine.reward', x: 0, z: 6 } }],
    },
  ],
