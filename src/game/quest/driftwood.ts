...
export const DRIFTWOOD_QUEST: QuestDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      markers: [{ id: 'shrine', label: 'RING SHRINE', at: { poi: 'shrine', x: 0, z: -2.4 } }],
    },
    {
      id: 'captain',
      ...
      markers: [{ id: 'captain', label: 'THE DROWNED CAPTAIN', at: { poi: 'shrine', x: 0, z: -9 } }],
    },
    {
      id: 'reward',
      ...
      markers: [{ id: 'ring', label: 'THE RING', at: { poi: 'shrine', x: 0, z: -1 } }],
    },
  ],
