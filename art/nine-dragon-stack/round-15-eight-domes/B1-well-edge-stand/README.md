# Dome B1 · B1-well-edge-stand (E169, round 15: the eight domes)

mockup B's own camera: standing at the carved stone balustrade on the Yamen Well's south rim, +125.4 m. Mockup: `art/nine-dragon-stack/round-6-baseline-hud/comp-B-well-edge.jpg`. Pair: `B2-well-edge-look`. Anchor (ground): (-10.5, 125.4, 11.75).
...
|---|---|---|---|---|---|---|
| 1 | look up | fp | (-10.5, 127.02, 11.75) | -3.0 | +62.0 | 62 |
| 2 | aerial over the rim | aerial | (-14.0, 146.0, 15.0) | +1.6 | -44.2 | 60 |
| 3 | aerial from the square | aerial | (8.0, 144.0, -2.0) | -126.6 | -40.9 | 60 |
| 4 | turn left (west) | fp | (-10.5, 127.02, 11.75) | -93.0 | -6.0 | 62 |
| 5 | THE MOCKUP | fp | (-10.5, 127.02, 11.75) | -3.0 | -23.0 | 62 |
| 6 | turn right (east) | fp | (-10.5, 127.02, 11.75) | +87.0 | -6.0 | 62 |
| 7 | turn around (south) | fp | (-10.5, 127.02, 11.75) | +177.0 | +4.0 | 62 |
| 8 | look down | fp | (-10.5, 127.02, 11.75) | -3.0 | -80.0 | 62 |
| 9 | aerial from mid-shaft, back | aerial | (-17.0, 138.0, -26.0) | +170.2 | -18.7 | 60 |
