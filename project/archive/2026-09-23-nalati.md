...
| the clean-room prototype (reference only — it cheats) | `dev/nalati-cleanroom/` (removed from the tree before the merge onto main; history `247572c`), https://nalati-cleanroom.vercel.app |
...
| topic | decision |
|---|---|
| **Art style** | **B — stylized painterly** (`art/nalati-grasslands/round-1/1-art-style/style-B-painterly.jpg` is the master frame) |
