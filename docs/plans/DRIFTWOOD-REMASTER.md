...
| M2 | Every POI to its mockup (`art/driftwood-*` fp + poi rounds): pier, boat, hut (**with an interior**), lookout, bridge, wreck (**with a hold you can enter**), shrine, cove (**open cave mouth**), palms (fluffy sphere-normal fronds, 3-layer wind), boulders, props | **in progress** — WRECK + enterable hold **done** `0b918f5` (anchors + `holdBounds`; progress/168-model-m2-*); SEA CAVE **done** `29f6541` (live 29f6541-mudq2tct: walkable cave from the mouth at (142, 14.5), anchors caveFloor / plateA / plateB / barrelStart / gate / alcove + `caveBounds`, runtime PointLight removed; phone calls pier 83 / beach 83 / wreck 96 / shrine 69; progress/175); next: shrine → hut + lookout → pier / boat |
