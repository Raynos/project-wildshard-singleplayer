...
**State:** `in progress` 2026-09-23 — the user: "build the plan to completion until ready to archive". Built: X1 title, X2 god mode, X3 Model Explorer, X4 select, X5 mini map, X6 go-there. Next: X7 detail tiers, X8 creature viewer + lineup, X9 A/B vs mockup, X10 generic. Owner: session wildshard-singleplayer-8d (E14).
