...
| G5 | **Ghost stag drops a skinned crossbow, Old Ironhide drops a skinned AR-15** — the drop lies on the floor (the floating-pickup presentation the other agent is mocking); picking it up just swaps the skin for now ("obviously the skinned version is cooler and better"). **Mockups of what "cool" means** for each | **in flight** | codex runs → art/skin-crossbow-{A,B}.png, art/skin-rifle-{A,B}.png |
